pipeline {
  ...
  stages {
    ...
    //           script {
    //             try {
    //               sh '''docker pull eeacms/ied-backend; docker run --rm -d --name="$BUILD_TAG-plone-eeacms" -e SITE="Plone" -e PROFILES="eea.kitkat:testing" eeacms/ied-backend'''
    ...
    //           script {
    //             try {
    //               sh '''docker pull eeacms/ied-backend; docker run --rm -d --name="$BUILD_TAG-plone-slate" -e SITE="Plone" -e PROFILES="eea.kitkat:testing" eeacms/ied-backend'''
